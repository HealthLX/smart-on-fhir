...
export DESCRIPTION_PAYLOAD="<promoteRequest>\
    <data>\
        <description>smart-on-fhir release</description>\
    </data>\
</promoteRequest>"
...
# <promoteResponse>  <data>    <stagedRepositoryId>orgopenstreetmapatlas-1147</stagedRepositoryId>    <description>Release</description>  </data></promoteResponse>

export CLOSE_PAYLOAD="<promoteRequest>\
    <data>\
        <stagedRepositoryId>$STAGING_ID</stagedRepositoryId>\
        <description>Close Smart-on-fhir repo</description>\
    </data>\
</promoteRequest>"
